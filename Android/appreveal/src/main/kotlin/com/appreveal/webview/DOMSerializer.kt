...
internal object DOMSerializer {
    ...
    fun dumpTreeJS(root: String?, maxDepth: Int, visibleOnly: Boolean): String {
    ...
    fun queryJS(selector: String, limit: Int): String {
        return """
        (function() {
    ...
    fun findTextJS(text: String, tag: String?): String {
        val tagSelector = tag ?: "*"
        return """
        (function() {
    ...
    fun typeJS(selector: String, text: String, clear: Boolean): String {
    ...
    fun selectJS(selector: String, value: String): String {
        return """
        (function() {
            var el = document.querySelector('${escapeJS(selector)}');
    ...
    fun toggleJS(selector: String, checked: Boolean): String {
        return """
        (function() {
            var el = document.querySelector('${escapeJS(selector)}');
            if (!el) return JSON.stringify({error:'Element not found: ${escapeJS(selector)}'});
