...
class WebViewDemoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_webview_demo, container, false)
    }
    ...
    override fun onResume() {
        super.onResume()
        ExampleRouter.push("webview.demo")
    }
...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        th { background: #f0f0f0; font-size: 13px; color: #6e6e73; }
    </style>
</head>
<body>
    <h1>Web View Demo</h1>
    ...
    <div class="card">
        ...
        <input type="password" id="password-input" name="password" placeholder="Enter password" data-testid="form-password">
    ...
    <div class="card">
        ...
        <table>
            ...
            <tbody>
                <tr><td>Headphones</td><td>$59.99</td><td>42</td></tr>
                <tr><td>Keyboard</td><td>$199.00</td><td>15</td></tr>
                <tr><td>Speaker</td><td>$149.99</td><td>28</td></tr>
                <tr><td>USB-C Hub</td><td>$45.00</td><td>63</td></tr>
            </tbody>
        </table>
    </div>
